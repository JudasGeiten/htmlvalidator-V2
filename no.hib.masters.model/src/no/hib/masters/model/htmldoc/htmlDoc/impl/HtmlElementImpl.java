 ...
 * </p>
 * <ul>
 *   <li>{@link no.hib.masters.model.htmldoc.htmlDoc.impl.HtmlElementImpl#getID <em>ID</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class HtmlElementImpl extends MinimalEObjectImpl.Container implements HtmlElement {
	...
	protected EClass eStaticClass() {
		return HtmlDocPackage.Literals.HTML_ELEMENT;
	}
	...
	public void setID(String newID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HtmlDocPackage.HTML_ELEMENT__ID, oldID, id));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case HtmlDocPackage.HTML_ELEMENT__ID:
				return getID();
		}
