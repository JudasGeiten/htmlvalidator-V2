...
public class ModelSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ModelPackage.HTML_ROOT: {
				HtmlRoot htmlRoot = (HtmlRoot)theEObject;
				T result = caseHtmlRoot(htmlRoot);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ModelPackage.FORM_STEP: {
				FormStep formStep = (FormStep)theEObject;
				T result = caseFormStep(formStep);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ModelPackage.FORM_ELEMENT: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Html Root</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Html Root</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseHtmlRoot(HtmlRoot object) {
		return null;
	}
